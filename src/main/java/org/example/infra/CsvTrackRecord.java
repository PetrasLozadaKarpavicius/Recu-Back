...
public class CsvTrackRecord {
    ...
    public CsvTrackRecord(String trackName, String albumTitle, String artistName,
    ...
    public static CsvTrackRecord fromColumns(List<String> cols) {
        // Ajustar índices según tu CSV real
        return new CsvTrackRecord(
    ...
    public List<String> validate() { // retorna lista de errores (vacía si ok)
    ...
    private static MediaType findOrCreateMediaType(EntityManager em, String name) {
    ...
    private static Genre findOrCreateGenre(EntityManager em, String name) {
        if (name == null) return null;
